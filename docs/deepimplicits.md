...
trct  learnable parameterstarget low-poly reconstruction with sharp featurescoe 
...
SIREN [X] dives into this ideia and proposes periodic activation functions for neural networks as a mean to improve its convergence to high frequency details of signals. By using a basis of sinus functions 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE1NzMwNjY4ODEsMTMzMTk2MjUwNiwtMT
