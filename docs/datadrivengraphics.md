...
A point cloud is a set of data points in space with no specific order. It's a common output of scanning processes and could be retrie
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTIwMjAxMzcyNTAsNzM3NzUzMzc1LDgzOT
