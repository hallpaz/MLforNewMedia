...
Depth images and RGB-D data are quite easy to capture nowadays. It's been over a decade since low cost devices as the Kinect are available in the market and we had multiple works to reduce noise  and reconstruct surfaces from these kind of data.
kinect...
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNzIxMTYxNDIyLC0xMTk4NzU2MTYxLDE0Nj
c5MzM2MzFdfQ==
-->