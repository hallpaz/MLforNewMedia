...
The simplicity of this representation comes at the cost of a high memory footprint as we have to store data for both occupied and unoccupied voxels. By using a hierarchical data structure such as an octree, 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNTg4ODYxNDY5LDQzNDMyNTQzMSwtMTg5OT
U4MDI0OSwtNTMyMTcwMTYxLC0xMTk4NzU2MTYxLDE0Njc5MzM2
MzFdfQ==
-->